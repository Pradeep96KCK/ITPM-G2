      ...
      <body bgcolor="#6BB5F6">
        ...
        <div class="reg-form"><center><h1><font color="grey"><b>Create New Account</b></font></h1></center>
            ...
            <form  method="post" action="reg.php" >           
                ...
                <div class="input id">
                    <input type="text" id="userID" name="userID" placeholder="Your ID" required/>
                </div>
               <div class="input fname">
                ...
                <div class="input email">
                    <input type="text" id="email" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="please enter a valid email"/>
                </div>
                 <div class="input mbl">
                    <input type="text" id="pno" name="pno" value="" size="10" maxlength="10" placeholder="Phone Number"/>
                </div>
                 ...
                 <div class="input pass">
                    <input type="password" placeholder="Confirm Password" id="cmpsw" name="cmpsw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Re-type the password" required>
                </div>
