...
<div id="div1">
      ...
      <div id="div13">
      <h4 id="head1">Assignments</h4>
      <br><br><br>

      

      <h3 class="head2"><a class="link2" target="blank" href="downloads/java_application_ticket_booking_sysytem.rar">Assignment 01</a> </h3>
      <?php
      ...
      <br><br>
      <hr>
      <h3 class="head2"><a class="link2" target="blank" href="downloads/html-css-tutorial-part2.rar">Assignment 02</a>
      <?php
      if($_SESSION['username']=="lec"){
      	echo'
      <a href="download.php">Download</a></h3>' ;} 
      ?> 
      <br><br>
      <hr>
      <h3 class="head2"><a class="link2" href="">Assignment 03</a></h3>
      <br><br>
      <hr>
      <h3 class="head2"><a class="link2" href="">Assignment 04</a></h3>
      <br><br>
      <hr>
      <h3 class="head2"><a class="link2" href="">Assignment 05</a></h3>
      <br><br>
      <hr>
      <h3 class="head2"><a class="link2" href="">Assignment 06</a></h3>
      <br><br>
      <hr>
